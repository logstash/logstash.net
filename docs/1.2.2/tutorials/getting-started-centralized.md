...
Put this in a file and call it 'shipper.conf' (or anything, really), and run: 
    ...
    java -jar logstash-1.2.2-flatjar.jar agent -f shipper.conf
...
`java -jar logstash-1.2.2-flatjar.jar agent -f indexer.conf`
...
argument. 
    ...
    java -jar logstash-1.2.2-flatjar.jar web
