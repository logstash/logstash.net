...
* [logstash-1.1.2.dev-monolithic.jar](http://semicomplete.com/files/logstash/logstash-1.1.2.dev-monolithic.jar)
...
### Run it:
    ...
    java -jar logstash-1.1.2.dev-monolithic.jar agent -f hello.conf
...
### Run it:
    ...
    java -jar logstash-1.1.2.dev-monolithic.jar agent -f hello-search.conf
...
### Run it:
    ...
    java -jar logstash-1.1.2.dev-monolithic.jar agent -f hello-search.conf -- web --backend 'elasticsearch:///?local'
...
### Run it
    ...
    java -jar logstash-1.1.2.dev-monolithic.jar agent -f apache-parse.conf
...
### Run it
    ...
    java -jar logstash-1.1.2.dev-monolithic.jar agent -f apache-elasticsearch.conf -- web --backend 'elasticsearch:///?local'
...
* [Getting started 'standalone' guide](http://logstash.net/docs/1.1.2.dev/tutorials/getting-started-simple)
* [Getting started 'centralized' guide](http://logstash.net/docs/1.1.2.dev/tutorials/getting-started-centralized) - 
  learn how to build out your logstash infrastructure and centralize your logs.
* [Dive into the docs](http://logstash.net/docs/1.1.2.dev/)
