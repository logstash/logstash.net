...
* [Monolithic jar](http://semicomplete.com/files/logstash/logstash-1.0.17pre-monolithic.jar)
* [rubygem](http://rubygems.org/gems/logstash/versions/1.0.17pre)
* [`gem install logstash -v 1.0.17pre`](http://rubygems.org/gems/logstash)
