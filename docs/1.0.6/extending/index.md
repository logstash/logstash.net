...
* [inputs/beanstalk](https://github.com/logstash/logstash/blob/v1.0.6/lib/logstash/inputs/beanstalk.rb)
* [filters/multiline](https://github.com/logstash/logstash/blob/v1.0.6/lib/logstash/filters/multiline.rb)
* [outputs/mongodb](https://github.com/logstash/logstash/blob/v1.0.6/lib/logstash/outputs/mongodb.rb)
