...
Follow [this link to download logstash-1.2.3.dev-bb6ad44](https://download.elasticsearch.org/logstash/logstash/logstash-1.2.3.dev-bb6ad44-flatjar.jar).
...
Put this in a file and call it 'shipper.conf' (or anything, really), and run: 
    ...
    java -jar logstash-1.2.3.dev-bb6ad44-flatjar.jar agent -f shipper.conf
...
`java -jar logstash-1.2.3.dev-bb6ad44-flatjar.jar agent -f indexer.conf`
...
argument. 
    ...
    java -jar logstash-1.2.3.dev-bb6ad44-flatjar.jar web
