...
* [Monolithic jar](http://semicomplete.com/files/logstash/logstash-1.1.0beta8-monolithic.jar)
* [rubygem](http://rubygems.org/gems/logstash/versions/1.1.0beta8)
* [`gem install logstash -v 1.1.0beta8`](http://rubygems.org/gems/logstash)
