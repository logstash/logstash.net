...
* [Monolithic jar](http://semicomplete.com/files/logstash/logstash-1.0.15rc1-monolithic.jar)
* [rubygem](http://rubygems.org/gems/logstash/versions/1.0.15rc1)
* [`gem install logstash -v 1.0.15rc1`](http://rubygems.org/gems/logstash)
