...
Now you should have the file named *logstash-1.4.5.tar.gz* on your
local filesystem. Let’s unpack it:

    tar zxvf logstash-1.4.5.tar.gz
    cd logstash-1.4.5
...
> **Note**
>
> This tutorial specifies running Logstash 1.4.5 with Elasticsearch
...
Elasticsearch Plugins (an aside) {#_elasticsearch_plugins_an_aside}
--------------------------------
