...
* [logstash-1.4.5.tar.gz](https://download.elasticsearch.org/logstash/logstash/logstash-1.4.5.tar.gz)

    curl -O https://download.elasticsearch.org/logstash/logstash/logstash-1.4.5.tar.gz

### Unpack it

    tar -xzf logstash-1.4.5.tar.gz
    cd logstash-1.4.5
...
* [Getting started 'standalone' guide](http://logstash.net/docs/1.4.5/tutorials/getting-started-simple)
* [Getting started 'centralized' guide](http://logstash.net/docs/1.4.5/tutorials/getting-started-centralized) - 
  learn how to build out your logstash infrastructure and centralize your logs.
* [Dive into the docs](http://logstash.net/docs/1.4.5/)
