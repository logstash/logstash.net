...
* [Monolithic jar](http://semicomplete.com/files/logstash/logstash-1.0.15-monolithic.jar)
* [rubygem](http://rubygems.org/gems/logstash/versions/1.0.15)
* [`gem install logstash -v 1.0.15`](http://rubygems.org/gems/logstash)
