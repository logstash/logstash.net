...
Now you should have the file named *logstash-1.4.3.tar.gz* on your
local filesystem. Let’s unpack it:

    tar zxvf logstash-1.4.3.tar.gz
    cd logstash-1.4.3
...
> **Note**
>
> This tutorial specifies running Logstash 1.4.3 with Elasticsearch
