...
an older version to version 1.4.3. This document is intended to supplement
a the [changelog
file](https://github.com/elasticsearch/logstash/blob/v1.4.3/CHANGELOG) by
...
* Unpack it (`tar -zxf logstash-1.4.3.tar.gz`)
* `cd logstash-1.4.3`
% Run it: `bin/logstash ...`
...
page](http://logstash.net/docs/1.4.3/contrib-plugins)
