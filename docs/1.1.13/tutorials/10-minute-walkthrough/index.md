...
* [logstash-1.1.13-flatjar.jar](https://download.elasticsearch.org/logstash/logstash/logstash-1.1.13-flatjar.jar)
...
* [Getting started 'standalone' guide](http://logstash.net/docs/1.1.13/tutorials/getting-started-simple)
* [Getting started 'centralized' guide](http://logstash.net/docs/1.1.13/tutorials/getting-started-centralized) - 
  learn how to build out your logstash infrastructure and centralize your logs.
* [Dive into the docs](http://logstash.net/docs/1.1.13/)
