...
for easy downloading of ElasticSearch:
    ...
    ES_PACKAGE=elasticsearch-0.20.6.zip
...
Follow [this link to download logstash-1.1.13](https://download.elasticsearch.org/logstash/logstash/logstash-1.1.13-flatjar.jar).
...
Put this in a file and call it 'shipper.conf' (or anything, really), and run: 
    ...
    java -jar logstash-1.1.13-flatjar.jar agent -f shipper.conf
...
argument. 
    ...
    java -jar logstash-1.1.13-flatjar.jar web --backend elasticsearch://127.0.0.1/
