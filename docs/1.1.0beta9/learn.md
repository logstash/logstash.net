...
* [Monolithic jar](http://semicomplete.com/files/logstash/logstash-1.1.0beta9-monolithic.jar)
* [rubygem](http://rubygems.org/gems/logstash/versions/1.1.0beta9)
* [`gem install logstash -v 1.1.0beta9`](http://rubygems.org/gems/logstash)
