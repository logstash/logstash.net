...
* [Getting started 'standalone' guide](http://logstash.net/docs/1.1.0beta9/getting-started-simple)
* [Getting started 'centralized' guide](http://logstash.net/docs/1.1.0beta9/getting-started-centralized) - 
