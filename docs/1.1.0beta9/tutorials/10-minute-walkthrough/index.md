...
* [Getting started 'standalone' guide](http://logstash.net/docs/1.1.0beta9/tutorials/getting-started-simple)
* [Getting started 'centralized' guide](http://logstash.net/docs/1.1.0beta9/tutorials/getting-started-centralized) - 
