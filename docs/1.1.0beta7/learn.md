...
* [Monolithic jar](http://semicomplete.com/files/logstash/logstash-1.1.0beta7-monolithic.jar)
* [rubygem](http://rubygems.org/gems/logstash/versions/1.1.0beta7)
* [`gem install logstash -v 1.1.0beta7`](http://rubygems.org/gems/logstash)
