...
Now you should have the file named *logstash-1.4.2.tar.gz* on your
...
> 1.4.2. Each release of Logstash has a
...
patterns](https://github.com/logstash/logstash/blob/v1.4.2/patterns/grok-patterns)
on github.
