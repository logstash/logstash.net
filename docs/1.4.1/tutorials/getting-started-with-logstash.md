...
version:[http://www.oracle.com/technetwork/java/index.html](http://www.oracle.com/technetwork/java/index.html)
...
Now you should have the file named *logstash-1.4.1-modified.tar.gz* on your
local filesystem. Let’s unpack it:

    tar zxvf logstash-1.4.1-modified.tar.gz
...
> **Note**
>
> This tutorial specifies running Logstash 1.4.1-modified with Elasticsearch
