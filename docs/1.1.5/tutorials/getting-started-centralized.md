...
Follow [this link to download logstash-1.1.5](http://semicomplete.com/files/logstash/logstash-1.1.5-monolithic.jar).
...
`java -jar logstash-1.1.5-monolithic.jar agent -f indexer.conf`
