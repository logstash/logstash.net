...
Follow [this link to download logstash-1.1.7](https://download.elasticsearch.org/logstash/logstash/logstash-1.1.7-monolithic.jar).
...
`java -jar logstash-1.1.7-monolithic.jar agent -f indexer.conf`
...
argument. 
    ...
    java -jar logstash-1.1.7-monolithic.jar web --backend elasticsearch://127.0.0.1/
