...
* [logstash-1.1.7-monolithic.jar](https://download.elasticsearch.org/logstash/logstash/logstash-1.1.7-monolithic.jar)
...
### Run it:
    ...
    java -jar logstash-1.1.7-monolithic.jar agent -f hello.conf
...
### Run it:
    ...
    java -jar logstash-1.1.7-monolithic.jar agent -f hello-search.conf
...
### Run it:
    ...
    java -jar logstash-1.1.7-monolithic.jar agent -f hello-search.conf -- web --backend 'elasticsearch:///?local'
...
### Run it
    ...
    java -jar logstash-1.1.7-monolithic.jar agent -f apache-parse.conf
...
### Run it
    ...
    java -jar logstash-1.1.7-monolithic.jar agent -f apache-elasticsearch.conf -- web --backend 'elasticsearch:///?local'
...
* [Getting started 'standalone' guide](http://logstash.net/docs/1.1.7/tutorials/getting-started-simple)
* [Getting started 'centralized' guide](http://logstash.net/docs/1.1.7/tutorials/getting-started-centralized) - 
  learn how to build out your logstash infrastructure and centralize your logs.
* [Dive into the docs](http://logstash.net/docs/1.1.7/)
