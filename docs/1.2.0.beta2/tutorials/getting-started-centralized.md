...
Follow [this link to download logstash-1.2.0.beta2](http://logstash.objects.dreamhost.com/release/logstash-1.2.0.beta2-flatjar.jar).
...
Put this in a file and call it 'shipper.conf' (or anything, really), and run: 
    ...
    java -jar logstash-1.2.0.beta2-flatjar.jar agent -f shipper.conf
...
`java -jar logstash-1.2.0.beta2-flatjar.jar agent -f indexer.conf`
...
argument. 
    ...
    java -jar logstash-1.2.0.beta2-flatjar.jar web
