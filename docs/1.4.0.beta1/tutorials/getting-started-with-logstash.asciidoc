...
----
curl -O https://download.elasticsearch.org/logstash/logstash/logstash-1.4.0.beta1-flatjar.jar
----
Now you should have the file named 'logstash-1.4.0.beta1-flatjar.jar' on your local filesystem. Let's run it:
----
