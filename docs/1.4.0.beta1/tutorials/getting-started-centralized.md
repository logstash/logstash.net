...
for easy downloading of ElasticSearch:
    ...
    ES_PACKAGE=elasticsearch-1.0.0.zip
...
Follow [this link to download logstash-1.4.0.beta1-modified](https://download.elasticsearch.org/logstash/logstash/logstash-1.4.0.beta1-modified-flatjar.jar).
...
Put this in a file and call it 'shipper.conf' (or anything, really), and run: 
    ...
    java -jar logstash-1.4.0.beta1-modified-flatjar.jar agent -f shipper.conf
...
`java -jar logstash-1.4.0.beta1-modified-flatjar.jar agent -f indexer.conf`
...
argument. 
    ...
    java -jar logstash-1.4.0.beta1-modified-flatjar.jar web
