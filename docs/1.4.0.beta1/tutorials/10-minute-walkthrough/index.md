...
* [logstash-1.4.0.beta1-flatjar.jar](https://download.elasticsearch.org/logstash/logstash/logstash-1.4.0.beta1-flatjar.jar)
...
### Run it:
    ...
    java -jar logstash-1.4.0.beta1-flatjar.jar agent -f hello.conf
...
### Run it:
    ...
    java -jar logstash-1.4.0.beta1-flatjar.jar agent -f hello-search.conf
...
### Run it:
    ...
    java -jar logstash-1.4.0.beta1-flatjar.jar agent -f hello-search.conf -- web
...
### Run it
    ...
    java -jar logstash-1.4.0.beta1-flatjar.jar agent -f apache-parse.conf
...
### Run it
    ...
    java -jar logstash-1.4.0.beta1-flatjar.jar agent -f apache-elasticsearch.conf -- web
