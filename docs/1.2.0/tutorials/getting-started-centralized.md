...
Follow [this link to download logstash-1.2.0](https://download.elasticsearch.org/logstash/logstash/logstash-1.2.0-flatjar.jar).
...
Put this in a file and call it 'shipper.conf' (or anything, really), and run: 
    ...
    java -jar logstash-1.2.0-flatjar.jar agent -f shipper.conf
