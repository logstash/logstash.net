...
* [inputs/tcp](https://github.com/logstash/logstash/blob/v1.1.4/lib/logstash/inputs/tcp.rb)
* [filters/multiline](https://github.com/logstash/logstash/blob/v1.1.4/lib/logstash/filters/multiline.rb)
* [outputs/mongodb](https://github.com/logstash/logstash/blob/v1.1.4/lib/logstash/outputs/mongodb.rb)
